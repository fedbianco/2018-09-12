...
import it.polito.tdp.poweroutages.model.NeighbourVertex;
...
public class PowerOutagesController {
    ...
    void doVisualizzaVicini(ActionEvent event) {
    	...
    	for(NeighbourVertex nv : this.model.getNeighbour(nerc)) {
    		txtResult.appendText("-" + nv + "\n");
    	}
    ...
    public void setModel(Model model) {
		this.model = model;
		this.cmbBoxNerc.getItems().addAll(this.model.getAllNerc());
